    ...
    <div className="bg-[#2a2d3e] border border-[#3a3d4e] rounded-lg p-4">
      ...
      <div className="space-y-3 max-h-64 overflow-y-auto custom-scrollbar">
        {favorites.map((favorite, index) => (
          <div
            key={favorite.id}
            className="group bg-[#1e212f] hover:bg-[#252837] border border-[#3a3d4e]/50 hover:border-[#3A6FF8]/50 rounded-lg p-3 transition-all duration-200 hover:shadow-lg cursor-pointer"
