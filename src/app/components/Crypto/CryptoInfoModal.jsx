        ...
        if (priceData?.prices) {
          ...
          formattedData = Array.from({ length: 30 }, (_, i) => {
            ...
            return {
              ...
              date: new Date(now - (29 - i) * dayMs).toLocaleDateString(),
              time: new Date(now - (29 - i) * dayMs).toLocaleTimeString(),
              price: price,
        ...
        >
          {loading ? (
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#2a2d3e] to-[#212332] rounded-3xl max-w-6xl w-full max-h-[95vh] flex items-center justify-center shadow-2xl border border-gray-600/20"
                      ...
                      {!useCustomDates && (
                        <div className="flex flex-wrap items-center gap-2 bg-gradient-to-r from-[#2a2d3e]/80 to-[#252837]/80 rounded-2xl p-3 border border-gray-600/30 backdrop-blur-sm">
                          {[
                            ...
                            { key: 'all', label: 'Tout', name: 'Toutes données' }
                          ].map(period => (
                            <button
                              key={period.key}
                              onClick={() => handlePeriodChange(period.key)}
                              className={`px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 whitespace-nowrap ${
                      ...
                      {useCustomDates && (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                          <div className="space-y-3">
                            ...
                            <input
                              ...
                              max={tempEndDate}
                              className="w-full px-4 py-3 rounded-xl bg-gradient-to-r from-[#3a3d4e] to-[#2a2d3e] border-2 text-white text-sm focus:outline-none transition-all duration-200 hover:shadow-lg"
                              style={{ 
                        ...
                        <div className="flex justify-end">
                          <button
                            ...
                            className="px-6 py-3 rounded-xl text-white font-semibold transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100"
                            style={{
                              background: `linear-gradient(135deg, ${cryptoColors.primary}, ${cryptoColors.secondary})`,
                            }}
                          >
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      {detailedInfo.links?.homepage?.[0] && (
                        <a 
                          ...
                          className="flex items-center justify-between p-4 bg-gradient-to-r from-[#3a3d4e] to-[#2a2d3e] rounded-xl hover:from-[#4a4d5e] hover:to-[#3a3d4e] transition-all duration-200 border border-gray-500/30 hover:border-blue-400/50 shadow-md hover:shadow-lg"
                        >
