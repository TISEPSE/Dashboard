  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        disabled={isLoading}
        className="flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg border border-gray-300 hover:border-gray-400 transition-all duration-200 disabled:opacity-50 shadow-sm hover:shadow-md w-full max-w-[240px] sm:min-w-[220px] mx-4"
      >
