...
export default function AuthButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-4 py-2 rounded-lg transition-all duration-200 disabled:opacity-50"
    >
