...
export default function Register() {
  ...
  return (
    <div>
      <form className="modern-form" onSubmit={registerUser}>
        <div className="form-title">Crée un compte</div>
        ...
        <div className="form-body">
          <div className="input-group">
            <div className="input-wrapper">
              ...
              <input required placeholder="Username" className="form-input" type="text" value={data.name} onChange={(e) => setData({...data, name: e.target.value})}/>  {/* INPUT ICI */}
          ...
          <div className="input-group">
            <div className="input-wrapper">
              ...
              <input required placeholder="Email" className="form-input" type="email" value={data.email} onChange={(e) => setData({...data, email: e.target.value})} />  {/* INPUT ICI */}
            </div>
          </div>
          ...
          <div className="input-group">
            <div className="input-wrapper">
              ...
              <input required placeholder="Password" className="form-input" type="password" value={data.password} onChange={(e) => setData({...data, password: e.target.value})}/>  {/* INPUT ICI */}
              <button className="password-toggle" type="submit">
